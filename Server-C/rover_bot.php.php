...
if ($text=='/f@fpv_rover_bot' || $text=='/f') $text='m,0.6,0.6,2';
if ($text=='/b@fpv_rover_bot' || $text=='/b') $text='m,-0.6,-0.6,2';
if ($text=='/l@fpv_rover_bot' || $text=='/l') $text='m,-0.6,0.6,1';
if ($text=='/r@fpv_rover_bot' || $text=='/r') $text='m,0.6,-0.6,1';
